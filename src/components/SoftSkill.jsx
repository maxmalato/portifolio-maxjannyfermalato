const SoftSkill = () => {
    return (
      <section className="mb-10">
        ...
        <div className="grid grid-cols-2 gap-4 text-center lg:flex flex-wrap lg:border-l-4 lg:pl-4 transition-colors hover:border-orange-600 lg:dark:border-slate-100">
